...
const works = [
  ...
  {
    image: 'Img/csp1.png',
    title: 'b personal blog website',
    titleC: 'Keeping track of lists of blogs',
    titleM: 'Multi Post Stories',
    description: "This is a personal blog website that you can use and gives a platform where you can share thoughts, opinions, and stories about yourself.",
    descriptionM: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
    languages: ['css', 'html', 'bootstrap', 'ruby'],
    liveLinks: ['See live', 'See Source'],
  },
  {
    image: 'Img/abp.png',
    title: 'Awesome Books',
    titleC: 'Keeping track of lists of books',
    titleM: 'Multi Post Stories',
    description: "In this project I build a basic website that allows users to add/remove books from a list. This project is achieved by using JavaScript objects and arrays.",
    descriptionM: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
  ...
  },
  {
    image: 'Img/tdlp.png',
    title: 'Todo list',
    titleC: 'Keeping track of todo lists of a user',
    titleM: 'Multi Post Stories',
    description: "This To-do list is a tool that helps it's users to organize their day to day activities. It simply lists the things that you need to do and allows you to mark them as complete. This simple web page is built using javascript array boject, es6, and webpack.",
    descriptionM: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
    languages: ['css', 'html', 'bootstrap', 'ruby'],
    liveLinks: ['See live', 'See Source'],
  },
